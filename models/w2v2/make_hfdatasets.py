...
if __name__ == "__main__":
    ...
    parser.add_argument("-p_trim", "--trim_audio_path", type=str, default=None, help="the path of trim_audio")
    ...
    trim_audio_path = args.trim_audio_path
    if segments_mode :
        if trim_audio_path is None:
            raise ValueError(
    ...
    def map2segfile(batch):
        ...
        batch["file"] = trim_audio_path+"/"+batch["id"]+".flac"
        return batch
